...
public class BodyPartFragment extends Fragment {
    ...
    final String LIST_ARRAY = "LIST_ARRAY";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mImageIds = savedInstanceState.getIntegerArrayList(LIST_ARRAY);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        Log.e("BodyPartFragamen", "Saved State: " + mListIndex);
        outState.putIntegerArrayList(LIST_ARRAY, (ArrayList<Integer>) mImageIds);
